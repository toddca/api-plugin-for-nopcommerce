// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="GetRequestsErrorInterceptorActionFilter.cs" company="Lindell Management">
    ...
    public class GetRequestsErrorInterceptorActionFilter : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuted(ActionExecutedContext actionExecutedContext)
        {
                     ...
                     (HttpStatusCode) actionExecutedContext.HttpContext.Response.StatusCode != HttpStatusCode.OK)
            {
                ...
                {
                    var error = new KeyValuePair<string, List<string>>("lookup_error",
                                                                       new List<string>
                                                                       {
                                                                           "not found"
                                                                       });
