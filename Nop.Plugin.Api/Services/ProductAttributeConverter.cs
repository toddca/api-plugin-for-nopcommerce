// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="ProductAttributeConverter.cs" company="Lindell Management">
                ...
                switch (attribute.AttributeControlType)
                {
                        ...
                        if (selectedAttribute != null)
                        {
                            ...
                            if (isInt && selectedAttributeValue > 0)
                            {
                                attributesXml = _productAttributeParser.AddProductAttribute(attributesXml,
                                                                                            attribute,
                                                                                            selectedAttributeValue.ToString());
                            }
                        }
                    }
                        break;
                    ...
                    case AttributeControlType.Datepicker:
                    {
                        ...
                        if (selectedAttribute != null)
                        {
                            ...
                            var validDate = DateTime.TryParseExact(selectedAttribute.Value,
                                                                   "D",
                    ...
                    case AttributeControlType.FileUpload:
                    {
                        ...
                        if (selectedAttribute != null)
                        {
                            ...
                            if (download != null)
                            {
                                attributesXml = _productAttributeParser.AddProductAttribute(attributesXml,
                                                                                            attribute,
                                                                                            download.DownloadGuid.ToString());
                            }
                        }
                    }
                        break;
