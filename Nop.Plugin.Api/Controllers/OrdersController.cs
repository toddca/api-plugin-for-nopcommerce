// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="OrdersController.cs" company="Lindell Management">
...
namespace Nop.Plugin.Api.Controllers
{
    public class OrdersController : BaseApiController
    {
        ...
        private OrderSettings OrderSettings => _orderSettings ??= EngineContext.Current.Resolve<OrderSettings>();
        ...
        public IActionResult GetOrders(OrdersParametersModel parameters)
        {
            ...
            var orders = _orderApiService.GetOrders(parameters.Ids,
        ...
        public IActionResult GetOrdersCount(OrdersCountParametersModel parameters)
        {
            ...
            var ordersCount = _orderApiService.GetOrdersCount(parameters.CreatedAtMin,
                                                              parameters.CreatedAtMax,
                                                              parameters.Status,
                                                              parameters.PaymentStatus,
                                                              parameters.ShippingStatus,
            ...
            Delta<OrderDto> orderDelta)
        {
            ...
            CustomerActivityService.InsertActivity("AddNewOrder",
                                                   LocalizationService.GetResource("ActivityLog.AddNewOrder"),
                                                   newOrder);
            ...
            Delta<OrderDto> orderDelta)
        {
            ...
            if (shippingRequired)
            {
                    ...
                    !string.IsNullOrEmpty(orderDelta.Dto.ShippingMethod))
                {
                    ...
                    isValid &= SetShippingOption(orderDelta.Dto.ShippingRateComputationMethodSystemName ?? currentOrder.ShippingRateComputationMethodSystemName,
                                                 ...
                                                 storeId,
                                                 customer,
                                                 BuildShoppingCartItemsFromOrderItems(_orderService.GetOrderItems(currentOrder.Id).ToList(),
                                                                                      customer.Id,
                                                                                      storeId));
                }
            ...
            CustomerActivityService.InsertActivity("UpdateOrder",
                                                   LocalizationService.GetResource("ActivityLog.UpdateOrder"),
                                                   currentOrder);
            ...
            List<ShoppingCartItem> shoppingCartItems)
        {
            ...
            else
            {
                var shippingOptionResponse = _shippingService.GetShippingOptions(shoppingCartItems,
                                                                                 CustomerService.GetCustomerShippingAddress(customer),
                                                                                 customer,
        ...
        private bool AddOrderItemsToCart(ICollection<OrderItemDto> orderItems, Customer customer, int storeId)
        {
            ...
            foreach (var orderItem in orderItems)
            {
                if (orderItem.ProductId != null)
                {
                    ...
                    var errors = _shoppingCartService.AddToCart(customer,
                                                                product,
