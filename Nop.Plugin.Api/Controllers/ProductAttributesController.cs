// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="ProductAttributesController.cs" company="Lindell Management">
    ...
    public class ProductAttributesController : BaseApiController
    {
            ...
            Delta<ProductAttributeDto> productAttributeDelta)
        {
            ...
            CustomerActivityService.InsertActivity("AddNewProductAttribute",
                                                   LocalizationService.GetResource("ActivityLog.AddNewProductAttribute"),
                                                   productAttribute);
            ...
            Delta<ProductAttributeDto> productAttributeDelta)
        {
            ...
            CustomerActivityService.InsertActivity("EditProductAttribute",
                                                   LocalizationService.GetResource("ActivityLog.EditProductAttribute"),
                                                   productAttribute);
        ...
        public IActionResult DeleteProductAttribute(int id)
        {
            ...
            CustomerActivityService.InsertActivity("DeleteProductAttribute",
                                                   LocalizationService.GetResource("ActivityLog.DeleteProductAttribute"),
                                                   productAttribute);
