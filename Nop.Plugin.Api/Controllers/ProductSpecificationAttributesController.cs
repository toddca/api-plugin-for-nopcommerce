// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="ProductSpecificationAttributesController.cs" company="Lindell Management">
    ...
    public class ProductSpecificationAttributesController : BaseApiController
    {
        ...
        public IActionResult GetProductSpecificationAttributes(ProductSpecificationAttributesParametersModel parameters)
        {
            ...
            var productSpecificationAttribtues =
                _specificationAttributeApiService.GetProductSpecificationAttributes(parameters.ProductId,
                                                                                    parameters.SpecificationAttributeOptionId,
                                                                                    parameters.AllowFiltering,
                                                                                    parameters.ShowOnProductPage,
                                                                                    parameters.Limit,
                                                                                    parameters.Page,
                                                                                    parameters.SinceId);
