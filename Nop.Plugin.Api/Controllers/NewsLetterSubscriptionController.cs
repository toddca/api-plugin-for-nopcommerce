// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="NewsLetterSubscriptionController.cs" company="Lindell Management">
...
namespace Nop.Plugin.Api.Controllers
{
    public class NewsLetterSubscriptionController : BaseApiController
    {
        ...
        public NewsLetterSubscriptionController(
            ...
            INewsLetterSubscriptionService newsLetterSubscriptionService) : base(jsonFieldsSerializer,
                                                                                 aclService,
                                                                                 customerService,
                                                                                 storeMappingService,
                                                                                 storeService,
        ...
        public IActionResult GetNewsLetterSubscriptions(NewsLetterSubscriptionsParametersModel parameters)
        {
            ...
            var newsLetterSubscriptions = _newsLetterSubscriptionApiService.GetNewsLetterSubscriptions(parameters.CreatedAtMin,
