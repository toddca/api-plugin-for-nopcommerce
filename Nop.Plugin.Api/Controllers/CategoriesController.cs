// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="CategoriesController.cs" company="Lindell Management">
...
namespace Nop.Plugin.Api.Controllers
{
    public class CategoriesController : BaseApiController
    {
        ...
        public IActionResult GetCategories(CategoriesParametersModel parameters)
        {
            ...
            var allCategories = _categoryApiService.GetCategories(parameters.Ids,
            ...
            Delta<CategoryDto> categoryDelta)
        {
            ...
            CustomerActivityService.InsertActivity("AddNewCategory",
                                                   LocalizationService.GetResource("ActivityLog.AddNewCategory"),
                                                   category);
            ...
            Delta<CategoryDto> categoryDelta)
        {
            ...
            CustomerActivityService.InsertActivity("UpdateCategory",
                                                   LocalizationService.GetResource("ActivityLog.UpdateCategory"),
                                                   category);
        ...
        private void UpdateDiscounts(Category category, List<int> passedDiscountIds)
        {
            ...
            foreach (var discount in allDiscounts)
            {
                ...
                {
                    //new discount
                    if (appliedCategoryDiscount.All(d => d.Id != discount.Id))
                    {
                ...
                {
                    //remove discount
                    if (appliedCategoryDiscount.Any(d => d.Id == discount.Id))
                    {
