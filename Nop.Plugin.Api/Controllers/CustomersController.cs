// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="CustomersController.cs" company="Lindell Management">
...
namespace Nop.Plugin.Api.Controllers
{
    public class CustomersController : BaseApiController
    {
        ...
        public IActionResult GetCustomers(CustomersParametersModel parameters)
        {
            ...
            var allCustomers =
                _customerApiService.GetCustomersDtos(parameters.CreatedAtMin,
            ...
            Delta<CustomerDto> customerDelta)
        {
            ...
            if (!string.IsNullOrEmpty(customerDelta.Dto.LanguageId) &&
                int.TryParse(customerDelta.Dto.LanguageId, out var languageId) &&
