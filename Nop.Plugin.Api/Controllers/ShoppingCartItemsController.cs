// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="ShoppingCartItemsController.cs" company="Lindell Management">
    ...
    public class ShoppingCartItemsController : BaseApiController
    {
            ...
            Delta<ShoppingCartItemDto> shoppingCartItemDelta)
        {
            ...
            var warnings = _shoppingCartService.AddToCart(customer,
                                                          ...
                                                          newShoppingCartItem.RentalEndDateUtc,
            ...
            Delta<ShoppingCartItemDto> shoppingCartItemDelta)
        {
            ...
            var warnings = _shoppingCartService.UpdateShoppingCartItem(customer,
        ...
        public IActionResult DeleteShoppingCartItem(int id)
        {
            ...
            CustomerActivityService.InsertActivity("DeleteShoppingCartItem",
                                                   LocalizationService.GetResource("ActivityLog.DeleteShoppingCartItem"),
