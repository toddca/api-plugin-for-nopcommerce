// // -----------------------------------------------------------------------
// // <copyright from="2020" to="2020" file="MappingHelper.cs" company="Lindell Management">
...
namespace Nop.Plugin.Api.Helpers
{
    ...
    public class MappingHelper : IMappingHelper
    {
        ...
        private void SetValue(
            object objectToBeUpdated,
            KeyValuePair<string, object> propertyNameValuePair,
            Dictionary<object, object> objectPropertyNameValuePairs,
            bool handleComplexTypeCollections)
        {
            ...
            if (propertyToUpdate != null)
            {
                ...
                if (propertyValue is Dictionary<string, object>)
                {
                    ...
                    SetValues((Dictionary<string, object>) propertyValue,
                              valueToUpdate,
            ...
            bool handleComplexTypeCollections)
        {
            if (newProperties.ContainsKey("Id"))
            {
                ...
                if (itemToBeUpdated == null)
                {
                    ...
                    AddNewItemInCollection(newProperties,
                                           collection,
                                           collectionElementsType,
                                           objectPropertyNameValuePairs,
                                           handleComplexTypeCollections);
